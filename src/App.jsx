...
function App() {
  ...
  return (
    <main>
      ...
      <section id="about" className="about shell section-grid"><div><p className="kicker">{t.about.kicker}</p><h2>{t.about.title}</h2></div><div className="about-body"><p>{t.about.text}</p><div className="facts"><span>{t.about.location}</span><span>{t.about.experience}</span><span>{t.about.services}</span></div><div className="social-links"><a href="https://www.linkedin.com/in/antony-joaquim-0171b4402/" target="_blank" rel="noreferrer" aria-label="Antony Joaquim on LinkedIn">LinkedIn <span>↗</span></a><a href="https://github.com/antonynegdas-blip" target="_blank" rel="noreferrer" aria-label="Antony Joaquim on GitHub">GitHub <span>↗</span></a></div></div></section>
